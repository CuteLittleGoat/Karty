...
15. W plikach Main/docs/Documentation.md, Main/docs/README.md, Kolumny.md, DetaleLayoutu.md nie przechowuj archiwalnych informacji. Mają tam być tylko aktualne informacje a nie historia zmian.
...
17. Moduł "Main" ma też pełen dostęp do odczytu danych z folderów "Second", ale nie może ich modyfikować.
