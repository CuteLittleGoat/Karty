...
- W module Main modal „Szczegóły gry” (`.game-details-modal-card`) ma pionowe przewijanie w obszarze treści i sekcji tabeli (`.modal-body` + `.admin-table-scroll`), więc długie listy graczy pozostają edytowalne bez rozsuwania okna poza viewport.
