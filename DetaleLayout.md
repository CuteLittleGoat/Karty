...
- W module Main przyciski zbiorczej zmiany wag (`.admin-weight-bulk-button`) w tabelach statystyk zakładek **Gry admina** i **Statystyki** mają `min-width: 8ch`, aby etykiety `Waga1…Waga6` zawsze mieściły się w przycisku.
