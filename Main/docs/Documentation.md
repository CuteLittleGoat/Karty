...
- W modalach szczegółów gry (`.game-details-modal-card .modal-body`) działa pionowe przewijanie (`overflow-y: auto`), więc przy dużej liczbie graczy można dojść do wszystkich wierszy tabeli i przycisku `Dodaj`.
