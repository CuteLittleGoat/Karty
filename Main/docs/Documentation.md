...
- Przyciski zbiorczej edycji wag (`.admin-weight-bulk-button`) w sekcjach statystyk zakładek „Gry admina” i „Statystyki” mają `min-width: 8ch`, co zapobiega ucinaniu etykiet `Waga1…Waga6` na węższych viewportach.
