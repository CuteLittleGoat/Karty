...
- Logika identyfikacji graczy w modułach `Szczegóły gry`, `IlośćPotwierdzonych/Statusy`, `Statystyki` i `Kalkulator` została przepięta na `playerId`; pole `playerName` pozostaje prezentacyjne (snapshot nazwy do UI).
