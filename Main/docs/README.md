...
12. Gdy lista graczy jest długa, zawartość modalu ma pionowy pasek przewijania — przewiń w dół, aby edytować kolejne wiersze bez wychodzenia poza okno.
...
8. Przy większej liczbie uczestników modal ma pionowy scrollbar, więc możesz przewijać tabelę w dół i uzupełniać dane wszystkich graczy.
