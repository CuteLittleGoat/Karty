...
- W `renderUserTournament()` dostępność sekcji do renderu jest liczona bezpośrednio z wyniku `renderTournamentButtonsForPlayer()`, czyli z faktycznie odfiltrowanych przycisków sidebaru; eliminuje to fałszywy komunikat „Brak dostępnych paneli...” przy poprawnie nadanych uprawnieniach i widocznych przyciskach sekcji.
